...
export const LANDING_HEADER_LOGO_LINK_CLASS =
  'inline-flex w-auto shrink-0 items-center justify-start !h-auto min-h-0 -ml-1 p-0 leading-none opacity-100 hover:opacity-100 translate-y-[3px] sm:-ml-1.5 max-lg:translate-y-[5px]';
