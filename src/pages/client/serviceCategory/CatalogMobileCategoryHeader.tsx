...
import { CatalogMobileCategoryQuickFilters } from './CatalogMobileCategoryQuickFilters';
...
export function CatalogMobileCategoryHeader({
  title,
  closeTo,
  search,
  onSearchChange,
  ...
  return (
    ...
    >
      ...
      <div className={`border-b border-[#EAEAEA] bg-[#F5F5F5] pb-2.5 pt-2 ${catalogMobilePadX}`}>
        <CatalogMobileCategoryQuickFilters
          filters={filters}
