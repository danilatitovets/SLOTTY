...
import { adminMobileTabBarFabBottomClass } from '../shared/adminMobileTabBarTheme';
...
const FAB_SHELL = [
  'fixed right-4 z-40 flex h-14 w-14 items-center justify-center overflow-hidden rounded-full text-white',
