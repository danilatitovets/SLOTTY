...
import { adminMobileTabBarFabBottomClass } from './adminMobileTabBarTheme';
...
export function AdminToast({ toast, onDismiss }: Props) {
  ...
  return createPortal(
    <div
      className={`pointer-events-none fixed z-[350] flex justify-center px-4 transition-all duration-300 ease-out max-lg:inset-x-0 ${adminMobileTabBarFabBottomClass} lg:inset-x-auto lg:bottom-24 lg:right-8 lg:justify-end ${
