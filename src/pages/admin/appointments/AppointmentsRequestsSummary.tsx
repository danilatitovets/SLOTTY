...
const requestsKpiLabelClass = apptSummaryKpiLabelClass;

const requestsKpiValueClass = apptSummaryKpiValueClass;
    ...
    <div className={`relative z-10 flex w-full flex-col ${compact ? 'min-h-[5.5rem]' : 'min-h-[8.25rem]'}`}>
      ...
      <div className="mt-auto">
        {loading ? (
          ...
          <p
            className={
              compact ? apptSummaryKpiValueCompactClass : requestsKpiValueClass
            }
          >
            {value}
          </p>
