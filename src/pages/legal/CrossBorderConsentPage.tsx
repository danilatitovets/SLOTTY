    ...
    <LegalPageShell title="Согласие на трансграничную передачу персональных данных">
      ...
      <section>
        ...
        <p>
          ...
          уведомлений, авторизация через Telegram/Google, email (в т.ч. сервисные письма и marketing-рассылки через
          Resend). Перечень сервисов уточняется в Политике обработки персональных данных.
        </p>
      </section>
