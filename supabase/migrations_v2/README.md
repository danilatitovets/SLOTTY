...
- **`apply_all_v2.sql`** — только для ручной вставки в SQL Editor на **пустой** тестовой БД; пересборка: `npm run db:v2:build-all`. В обычной разработке **не** использовать вместо `db:v2:migrate`.
